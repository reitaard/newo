...
export function createAssistantTurnRuntime({ assistant, speakerRuntime, isPersistentSpeakerEnabled, maxReplyChars, logger, setAssistantState = () => {} }) {
  ...
  let closing = false;
  let latest = { result: "n/a", llmMs: null, llmFirstTokenMs: null, streamId: null, at: null, ttsQueuedMs: null, totalMs: null, asrFinalMs: null };

  function record(result, turn, fields = {}) {
    latest = {
      result, streamId: turn?.streamId ?? null, at: Date.now(), llmMs: null, llmFirstTokenMs: null,
