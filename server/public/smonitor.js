...
const shortNewo2 = location.pathname === "/2" || location.pathname.startsWith("/2/");
const shortNewo1 = location.pathname === "/1" || location.pathname.startsWith("/1/");
const monitorBase = shortNewo2 ? "/2" : shortNewo1 ? "/1" : location.pathname.startsWith("/smonitor2") ? "/smonitor2" : "/smonitor1";
const frameMagic = shortNewo2 || monitorBase === "/smonitor2" ? "NSM2" : "NSM1";
let receivedBytes = 0;
let lastSequence = 0;
let rawLog = "";
