...
static const char kIndexHtmlV5[] = R"HTML(
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
<meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover" />
<title>Newo GOOUUU Vision v5</title>
<style>
...
<body><main>
<h1>Newo / GOOUUU vision v5</h1>
<div class="sub">OV3660 native JPEG preview, shared JPEG pool, persistent decoders, and a block-decoded RANGE path. Stream and AI borrow the same published JPEG instead of making per-consumer copies.</div>
...
<div class="hint">VIEW = native VGA JPEG only · FAST = persistent JPEG scaler → 320×240 RGB565 → MSR+MNP · RANGE = JPEG block decode → one rotating 384×288 ROI, no full VGA RGB frame · ACCURATE = full VGA RGB565 → ESPDet-224 · BENCH = FAST AI with preview stopped</div>
<div class="toolbar">
...
<div class="grid">
  ...
  <div class="card"><div class="k">Camera capture wait</div><div class="v" id="captureMs">-</div></div>
  <div class="card"><div class="k">JPEG publish copy</div><div class="v" id="publishMs">-</div></div>
  <div class="card"><div class="k">JPEG pool drops</div><div class="v" id="poolDrops">-</div></div>
  ...
  <div class="card"><div class="k">ROI copy</div><div class="v" id="prepMs">-</div></div>
